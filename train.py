    ...
    for epoch in range(start_epoch, epochs):
        ...
        if prebias:
            if epoch < 3:  # prebias
                ...
                ps = np.interp(epoch, [0, 3], [0.1, hyp['lr0']]), 0.0
        ...
        for i, (imgs, targets, paths, _) in pbar:
            ...
            if ni < 1:
                ...
                if tb_writer:
                    tb_writer.add_image(f, cv2.imread(
                        f)[:, :, ::-1], dataformats='HWC')
        ...
        if not opt.notest or final_epoch:  # Calculate mAP
            is_coco = any([x in data for x in [
                          'coco.data', 'coco2014.data', 'coco2017.data']]) and model.nc == 80
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str,
                        default='data/ftech.data', help='*.data path')
    ...
    parser.add_argument('--arc', type=str, default='default',
                        help='yolo architecture')  # default, uCE, uBCE
    parser.add_argument(
